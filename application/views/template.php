...
<!DOCTYPE html>
<head>
<title>SISURAT - SMK TELKOM MALANG</title>
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                if($this->session->userdata('nama_jabatan') == 'Sekretaris')
                {
                    ...
                    <li>
                        <a class="active" href="'.base_url('index.php/surat/dashboard').'">
                            <i class="fa fa-dashboard"></i>
                            <span>Dashboard</span>
                        </a>
                    </li>
                    <li>
                        <a class="active" href="'.base_url('index.php/surat/surat_masuk').'">
                            <i class="fa fa-envelope"></i>
                            <span>Surat Masuk</span>
                        </a>
                    </li>
                    <li>
                        <a class="active" href="'.base_url('index.php/surat/suratkeluar').'">
                            <i class="fa fa-envelope"></i>
                    ...
                    echo'
                        <li>
                            <a class="active" href="'.base_url('index.php/surat/disposisisurat').'">
                                <i class="fa fa-envelope"></i>
